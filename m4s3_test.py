...
if __name__ == '__main__':
    preco_volume = 10  # ler_dimensoes_objeto()
    multiplicador_peso = 2  # ler_peso_objeto()
    multiplicador_rota = 1  # ler_rota()

    total = calcular_frete(
        preco_volume, multiplicador_peso, multiplicador_rota)
